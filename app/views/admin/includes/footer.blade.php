...
<script src="{{URL::to(trim('/'))}}/dashboard/js/externalscript.js"></script>
...
{{--
<script src="{{URL::to(trim('/'))}}/dashboard/js/plugins/morris/raphael.min.js"></script>
<script src="{{URL::to(trim('/'))}}/dashboard/js/plugins/morris/morris.min.js"></script>
<script src="{{URL::to(trim('/'))}}/dashboard/js/plugins/morris/morris-data.js"></script>--}}
