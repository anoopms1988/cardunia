        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="name" id="name" value="{{{$Dealer->name or ''}}}" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <select name="city" id="city" class="form-control">
                        ...
                        @if((isset($Dealer)&&!empty($Dealer))&&($cities_value->id==$Dealer->city()->first()->id))
                ...
                <div class="form-group">
                    ...
                    <select name="company" id="company" class="form-control">
                        ...
                        @if((isset($Dealer)&&!empty($Dealer))&&($companies_value->id==$Dealer->company()->first()->id))
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phonenumber" id="phonenumber" value="{{{$Dealer->phonenumber or ''}}}"
                           class="form-control" placeholder="Enter text">
                </div>
                <div class="form-group">
                    <label>Mobile number</label>
                    <input type="text" name="mobilenumber" id="mobilenumber" value="{{{$Dealer->mobilenumber or ''}}}"
                           class="form-control" placeholder="Enter text">
                </div>
            </div>
