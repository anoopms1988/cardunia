            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        @if (Session::has('emailmismatch'))
                           <div class="alert alert-info">{{ Session::get('emailmismatch') }}</div>
                        @endif
                            ...
                            <fieldset>
                             ...
                             {{--   <div class="checkbox">
                               ...
                               {{-- <a href="index.html" class="btn btn-lg btn-success btn-block">Login</a>--}}
                                <input name="login_form_submit" type="submit" class="btn btn-lg btn-success btn-block" value="Login">
                            </fieldset>
                       {{Form::close()}}
                    </div>
                </div>
