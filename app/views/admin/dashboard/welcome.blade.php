...
<h4>List all cars</h4><button class="btn btn-primary btn-lg pull-right" data-target="#myModal" data-toggle="modal"> Add New Car </button>
...
<tr >
    <td class="showvariant odd gradeX"  id="variantdetails1_{{$lp_value_carDetails->id}}">{{{$lp_value_carDetails->name or ''}}}</td>
    <td class="showvariant odd gradeX"  id="variantdetails2_{{$lp_value_carDetails->id}}">{{{$lp_value_carDetails->company()->first()->name or ''}}}</td>
    <td> <button class="deletecar btn btn-danger" id="deletecarid_{{$lp_value_carDetails->id}}" type="button">Delete</button></td>
</tr>
@endforeach
</tbody>
</table>
