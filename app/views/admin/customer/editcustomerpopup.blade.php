...
<div class="modal-body">
      <div class="form-group">
            ...
            <input type="text" name="first_name" id="first_name" value="{{{$Customer->first_name or ''}}}"  class="form-control" placeholder="Enter text">
      </div>
      <div class="form-group">
             <label>Last Name</label>
             <input type="text" name="last_name" id="last_name" value="{{{$Customer->last_name or ''}}}"  class="form-control" placeholder="Enter text">
       </div>
      <div class="form-group">
             <label>Email</label>
             <input type="text" name="email" id="email" value="{{{$Customer->email or ''}}}"  class="form-control" placeholder="Enter text">
       </div>
       <div class="form-group">
            <label>City</label>
       ...
       <div class="form-group">
            <label>Mobile number</label>
             <input type="text" name="mobilenumber" id="mobilenumber" value="{{{$Customer->mobilenumber or ''}}}"  class="form-control" placeholder="Enter text">
       </div>
