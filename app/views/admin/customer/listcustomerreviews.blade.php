...
<tr class="odd gradeX">
    ...
    <td>
        @if($reviews_value->is_approved==0)
            <button id="editapprove_{{$reviews_value->id}}" class="manipulatereviewdetails btn btn-primary btn-circle" type="button"  data-toggle="modal"><i class="fa fa-list"></i></button>
        @else
             <button id="editdisapprove_{{$reviews_value->id}}" class="manipulatereviewdetails btn btn-primary btn-circle" type="button"  data-toggle="modal"><i class="fa fa-list"></i></button>
        @endif
        <button id="delete_{{$reviews_value->id}}" class="manipulatereviewdetails btn btn-warning btn-circle" type="button"><i class="fa fa-times"></i></button>
    </td>
</tr>
