    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#dimensionModal" data-toggle="modal"> Add
                    Dimensions&Weights
                </button>
                @else
                <button class="btn btn-primary btn-lg " data-target="#dimensionModal" data-toggle="modal"> Edit
                    Dimensions&Weights
                </button>
                @endif
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#engineModal" data-toggle="modal"> Edit Engine
                    Specifications
                </button>

                @else
                <button class="btn btn-primary btn-lg " data-target="#engineModal" data-toggle="modal">Add Engine
                    Specifications
                </button>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#fuelModal" data-toggle="modal"> Add Fuel
                    Efficiency
                </button>
                @else
                <button class="btn btn-primary btn-lg " data-target="#fuelModal" data-toggle="modal"> Edit Fuel
                    Efficiency
                </button>
                @endif
            </div>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#wheelModal" data-toggle="modal"> Add Wheels &
                    Tyres
                </button>
                @else
                <button class="btn btn-primary btn-lg " data-target="#wheelModal" data-toggle="modal"> Edit Wheels &
                    Tyres
                </button>
                @endif
            </div>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#brakeModal" data-toggle="modal"> Add Brake
                    Details
                </button>
                @else
                <button class="btn btn-primary btn-lg " data-target="#brakeModal" data-toggle="modal"> Edit Brake
                    Details
                </button>
                @endif
            </div>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-primary btn-lg " data-target="#capacityModal" data-toggle="modal"> Add Capacity
                </button>
                @else
                <button class="btn btn-primary btn-lg " data-target="#capacityModal" data-toggle="modal"> Edit
                    Capacity
                </button>
                @endif
            </div>
...
<div class="col-lg-6">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button class="btn btn-primary btn-lg " data-target="#steeringModal" data-toggle="modal"> Add Steering
                details
            </button>
            @else
            <button class="btn btn-primary btn-lg " data-target="#steeringModal" data-toggle="modal"> Edit Steering
                details
            </button>
            @endif
        </div>
...
<div class="col-lg-6">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button class="btn btn-primary btn-lg " data-target="#priceModal" data-toggle="modal"> Add price details
            </button>
            @else
            <button class="btn btn-primary btn-lg " data-target="#priceModal" data-toggle="modal"> Edit price details
            </button>
            @endif
        </div>
        <!-- /.panel-heading -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                'post','name'=>'interior_features_form','url'=>'admin/updateinterior'))}}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                {{Form::open(array( 'method' =>
                'post','name'=>'exterior_features_form','url'=>'admin/updateexterior'))}}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                {{Form::open(array( 'method' =>
                'post','name'=>'exterior_features_form','url'=>'admin/uploadimage','files' => true))}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Torque</label>
                    <input type="text" name="torque" id="torque" class="form-control" placeholder="Enter text"
                           value="{{{$variant->engine()->first()->torque or ''}}}">
                </div>
                <div class="form-group">
                    <label>Displacement</label>
                    <input type="text" name="displacement" id="displacement" class="form-control"
                           placeholder="Enter text" value="{{{$variant->engine()->first()->displacement or ''}}}">
                </div>
                <div class="form-group">
                    <label>Power</label>
                    <input type="text" name="power" id="power" class="form-control" placeholder="Enter text"
                           value="{{{$variant->engine()->first()->power or ''}}}">
                </div>
                <div class="form-group">
                    <label>Cylinders</label>
                    <input type="text" name="cylinders" id="cylinders" class="form-control" placeholder="Enter text"
                           value="{{{$variant->engine()->first()->cylinders or ''}}}">
                </div>
                <div class="form-group">
                    <label>Valves per cylinder</label>
                    <input type="text" name="valvespercylinder" id="valvespercylinder" class="form-control"
                           placeholder="Enter text" value="{{{$variant->engine()->first()->valvespercylinder or ''}}}">
                </div>
                <div class="form-group">
                    <label>Valve mechanism</label>
                    <input type="text" name="valvemechanism" id="valvemechanism" class="form-control"
                           placeholder="Enter text" value="{{{$variant->engine()->first()->valvemechanism or ''}}}">
                </div>
                <div class="form-group">
                    <label>Cylinder configuration</label>
                    <input type="text" name="cylinderconfiguration" id="cylinderconfiguration" class="form-control"
                           placeholder="Enter text"
                           value="{{{$variant->engine()->first()->cylinderconfiguration or ''}}}">
                </div>
            </div>
...
<div class="modal fade" id="dimensionModal" tabindex="-1" role="dialog" aria-labelledby="dimensionModal"
     aria-hidden="true">
    <div class="modal-dialog">
        {{Form::open(array( 'method' =>
        'post','name'=>'dimension_form','id'=>'dimension_form','url'=>'admin/adddimension'))}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="length" id="length" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->length or ''}}}">
                </div>
                <div class="form-group">
                    <label>Overall Width</label>
                    <input type="text" name="width" id="width" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->width or ''}}}">
                </div>
                <div class="form-group">
                    <label>Overall Width</label>
                    <input type="text" name="height" id="height" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->height or ''}}}">
                </div>
                <div class="form-group">
                    <label>Wheel base</label>
                    <input type="text" name="wheelbase" id="wheelbase" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->wheelbase or ''}}}">
                </div>
                <div class="form-group">
                    <label>Boot Space</label>
                    <input type="text" name="bootspace" id="bootspace" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->bootspace or ''}}}">
                </div>
                <div class="form-group">
                    <label>Kerb weight</label>
                    <input type="text" name="kerbweight" id="kerbweight" class="form-control" placeholder="Enter text"
                           value="{{{$variant->dimension()->first()->kerbweight or ''}}}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="mileage_highway" id="mileage_highway" class="form-control"
                           placeholder="Enter text"
                           value="{{{$variant->Fuelefficiency()->first()->mileage_highway or ''}}}">
                </div>
                <div class="form-group">
                    <label>Mileage city</label>
                    <input type="text" name="mileage_city" id="mileage_city" class="form-control"
                           placeholder="Enter text"
                           value="{{{$variant->Fuelefficiency()->first()->mileage_city or ''}}}">
                </div>
                <div class="form-group">
                    <label>Mileage Overall</label>
                    <input type="text" name="mileage_overall" id="mileage_overall" class="form-control"
                           placeholder="Enter text"
                           value="{{{$variant->Fuelefficiency()->first()->mileage_overall or ''}}}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Tyres</label>
                    <input type="text" name="tyres" id="tyres" class="form-control" placeholder="Enter text"
                           value="{{{$variant->Wheel()->first()->tyres or ''}}}">
                </div>
                <div class="form-group">
                    <label>Wheel size</label>
                    <input type="text" name="wheelsize" id="wheelsize" class="form-control" placeholder="Enter text"
                           value="{{{$variant->Wheel()->first()->wheelsize or ''}}}">
                </div>
                <div class="form-group">
                    <label>Wheel type</label>
                    <input type="text" name="wheeltype" id="wheeltype" class="form-control" placeholder="Enter text"
                           value="{{{$variant->Wheel()->first()->wheeltype or ''}}}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="rear_brakes" id="rear_brakes" class="form-control" placeholder="Enter text"
                           value="{{{$variant->Brake()->first()->rear_brakes or ''}}}">
                </div>
                <div class="form-group">
                    <label>Front brakes</label>
                    <input type="text" name="front_brakes" id="front_brakes" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Brake()->first()->front_brakes or ''}}}">
                </div>
...
<div class="modal fade" id="capacityModal" tabindex="-1" role="dialog" aria-labelledby="capacityModal"
     aria-hidden="true">
    <div class="modal-dialog">
        {{Form::open(array( 'method' =>
        'post','name'=>'capacity_form','id'=>'capacity_form','url'=>'admin/addcapacity'))}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="tank_capacity" id="tank_capacity" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Capacity()->first()->tank_capacity or ''}}}">
                </div>
                <div class="form-group">
                    <label>Seating capacity</label>
                    <input type="text" name="seating_capacity" id="seating_capacity" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Capacity()->first()->seating_capacity or ''}}}">
                </div>
...
<div class="modal fade" id="steeringModal" tabindex="-1" role="dialog" aria-labelledby="steeringModal"
     aria-hidden="true">
    <div class="modal-dialog">
        {{Form::open(array( 'method' =>
        'post','name'=>'steering_form','id'=>'steering_form','url'=>'admin/addsteering'))}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="turning_radius" id="turning_radius" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Steering()->first()->turning_radius or ''}}}">
                </div>
                <div class="form-group">
                    <label>Steering Type</label>
                    <input type="text" name="steering_type" id="steering_type" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Steering()->first()->steering_type or ''}}}">
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="showroomprice" id="showroomprice" class="form-control"
                           placeholder="Enter text" value="{{{$variant->Price()->first()->showroomprice or ''}}}">
                </div>
                <div class="form-group">
                    <label>Onroad price</label>
                    <input type="text" name="onroadprice" id="onroadprice" class="form-control" placeholder="Enter text"
                           value="{{{$variant->Price()->first()->onroadprice or ''}}}">
                </div>
