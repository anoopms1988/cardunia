...
<button data-toggle="modal" data-target="#variantModal" class="btn btn-primary btn-lg pull-right"> Add New Variant </button>
...
<tr class=" odd gradeX" >
    <td class="variantdetails" id="variant_{{$lp_value_variantDetails->id}}">{{{$lp_value_variantDetails->name or ''}}}</td>
    <td class="variantdetails" id="variant_{{$lp_value_variantDetails->id}}">{{{$lp_value_variantDetails->type or ''}}}</td>
    <td> <button class="deletevariant btn btn-danger" id="deletevariantid_{{$lp_value_variantDetails->id}}" type="button">Delete</button></td>
</tr>
@endforeach
</tbody>
</table>
