            ...
            <div class="about-top">
                <div class="about-topgrids">
                    <div class="about-topgrid1">
                        ...
                        <img src="{{URL::to(trim('/'))}}/frontend/images/pic10.jpg" title="name">
                ...
                <div class="about-services">
                    ...
                    <div class="client">
                        <div class="about-team-left">
                            <a href="#"><img src="{{URL::to(trim('/'))}}/frontend/images/pic18.jpg" title="cars"></a>
                        </div>
                    ...
                    <div class="client">
                        <div class="about-team-left">
                            <a href="#"><img src="{{URL::to(trim('/'))}}/frontend/images/pic19.jpg" title="cars"></a>
                        </div>
                        <div class="about-team-right">
                            <p>tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante  netus et malesuada fames ac</p>
                        </div>
                    ...
                    <div class="client">
                        <div class="about-team-left">
                            <a href="#"><img src="{{URL::to(trim('/'))}}/frontend/images/pic20.jpg" title="cars"></a>
                        </div>
                        <div class="about-team-right">
                            <p>tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante  netus et malesuada fames ac</p>
                        </div>
                    ...
                    <div class="client">
                        <div class="about-team-left">
                            <a href="#"><img src="{{URL::to(trim('/'))}}/frontend/images/pic30.jpg" title="cars"></a>
                        </div>
                        <div class="about-team-right">
                            <p>tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante  netus et malesuada fames ac</p>
                        </div>
